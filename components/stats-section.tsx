      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center max-w-4xl mx-auto">
          <div className="animate-fade-up">
            <p className="text-4xl md:text-5xl font-bold text-teal-400">$<AnimatedNumber target={0} /></p>
            <p className="text-sm text-gray-400 mt-2">Planning Fees</p>
            <p className="text-xs text-gray-500">Always Free</p>
          </div>
          <div className="animate-fade-up delay-100">
            <p className="text-4xl md:text-5xl font-bold text-teal-400"><AnimatedNumber target={24} />hr</p>
            <p className="text-sm text-gray-400 mt-2">Response Time</p>
            <p className="text-xs text-gray-500">Guaranteed</p>
          </div>
          <div className="animate-fade-up delay-200">
            <p className="text-4xl md:text-5xl font-bold text-teal-400"><AnimatedNumber target={14} suffix="+" /></p>
